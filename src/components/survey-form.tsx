  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-10">
      <div className="mb-6 text-center">
        <div
          className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-sm"
        ...
        {state.status === "ready" && (
          <div className="flex flex-col gap-6">
            <p className="text-sm text-gray-600">
              ...
              <span className="font-semibold">{state.orderNumber}</span>.
            </p>
            ...
            <label className="flex flex-col gap-1.5 text-sm">
              ...
              <textarea
                className="min-h-20 rounded-lg border border-gray-200 p-3 text-sm outline-none focus:border-[#18376C]"
      ...
      <div className="flex flex-row-reverse justify-end gap-1" dir="ltr">
        {[1, 2, 3, 4, 5].map((star) => (
          <button
            ...
            style={{ color: star <= value ? "#F5A623" : "#E0E0E0" }}
          >
            ★
          </button>
        ))}
